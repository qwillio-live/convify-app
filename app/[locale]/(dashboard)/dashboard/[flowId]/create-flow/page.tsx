      ...
      >
        <div className="fixed top-0 z-[60] w-full">
          <header className="flex h-28 flex-wrap items-center justify-between gap-x-4 border-b bg-[#fcfdfe] px-4 lg:h-[60px] lg:flex-nowrap lg:gap-4 lg:px-6">
            ...
            <div className="tabs-list-container order-last flex h-1/2 w-full basis-full shadow-[rgba(0,0,0,0.07)_0px_1px_inset] lg:order-[unset] lg:h-full lg:w-auto lg:basis-auto">
              <TabsList className="flex !h-full bg-inherit py-0 lg:w-auto lg:justify-center">
                <TabsTrigger
                  className="h-full flex-1 rounded-none border-b-4 border-transparent data-[state=active]:border-current data-[state=active]:bg-inherit lg:flex-auto"
                  value="create"
                >
                  {t("Create")}
                </TabsTrigger>
            ...
            <div className="account-settings flex h-1/2 flex-row items-center justify-between gap-4 lg:h-full">
              <Link
                ...
                href={`/dashboard/${flowId}/preview-flow?screen=${firstScreenName}`}
                target="_blank"
              >
                <Button
                  variant="outline"
        ...
        <main
          className={`content relative z-50 mt-[60px] flex-1 overflow-hidden bg-[#FAFAFA] ${
