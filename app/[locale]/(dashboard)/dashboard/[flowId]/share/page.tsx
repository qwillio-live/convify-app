    ...
    <div className="min-h-screen w-full">
      <div className="min-h-screen flex flex-col">
        ...
        <main className="content border-t relative overflow-hidden bg-[#FAFAFA] flex-1 h-full">
          {
            isPublishedLoading ? (
              <div className="hidden sm:flex h-[calc(-52px+98vh)] flex-row items-start justify-between">
                  ...
                  <div className="flex h-full flex-col text-sm text-[rgb(38,38,39)]">
                    <div className="m-auto w-full max-w-[608px] flex-[0_0_auto]">
                      <div className="flex flex-row items-center justify-between">
                        <div className="flex items-center w-full max-w-[267.3px]">
                        ...
                        >
                          <div className="h-2 bg-gray-300 animate-pulse rounded w-24"></div>
                        </button>
                      </div>
                        ...
                        <div className="flex flex-row items-center justify-between">
                          <div className="flex">
                            {[...Array(5)].map((_, index) => (
                              <div
                                key={index}
                                className="flex h-[32px] w-11 flex-[0_0_auto] cursor-pointer items-center justify-center rounded-[4px] bg-gray-300 animate-pulse mx-1"
                              ></div>
                            ))}
                          </div>
                          <div className="flex">
                    ...
                    <div className="flex min-w-0 !flex-[1_0_auto] flex-col items-center pt-6">
                      <div
                        className="max-h-[585px] w-full flex-[1_0_auto] rounded-2xl bg-gray-300 transition-[width] duration-300 ease-in will-change-[width]">

                      </div>

                      <div className="relative mt-5 flex w-full items-end justify-center" style={{ marginBottom: "50px" }}>
