          ...
          <Accordion type="single" collapsible className="w-full">
            ...
            <AccordionItem value="item-2">
              ...
              <div className="flex flex-col items-center col-span-2 space-y-2">
                  ...
                  <Select
                  value={primaryFont}
                  onValueChange={(value) => dispatch(setPartialStyles({text: {primaryFont: value}}))}
                  >
                  ...
                  <SelectContent>
                    {
                      primaryFonts?.map((font,index) => {
                        return <SelectItem
                        key={index}
                        value={font.variable}>{font.name}</SelectItem>
                      })
                    }
                  </SelectContent>
                </Select>
                ...
                <div className="flex flex-col items-center col-span-2 space-y-2">
                  ...
                  <Select
                                    value={secondaryFont}
                                    onValueChange={(value) => dispatch(setPartialStyles({text: {secondaryFont: value}}))}
                  >
                  <SelectTrigger className="basis-full self-start">
