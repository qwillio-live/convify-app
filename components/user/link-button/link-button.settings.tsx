...
import { LinkButtonGen } from "./link-button.component"
import useLinkButtonThemePreset from "./useLinkButtonThemePresets"
...
export const LinkButtonSettings = () => {
  ...
  const { filledPreset, outLinePreset } = useLinkButtonThemePreset()
        ...
        <AccordionItem value="content">
          ...
          <AccordionContent className="grid grid-cols-2 gap-y-2 p-2">
            ...
            <div className="style-control col-span-2 flex w-full grow-0 basis-2/4 flex-row items-center gap-2">
              ...
              <Select
                defaultValue={
                  buttonAction === "redirect" ? "redirect" : prevScreen.screenId
                }
                value={
                  buttonAction === "redirect" ? "redirect" : prevScreen.screenId
                }
              ...
              <>
                <div className="style-control !col-span-2 flex w-full !grow-0 !basis-2/4 flex-row items-center gap-2">
                  ...
                  >
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value={"same-window"}>Same window</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
                <div className="style-control col-span-2 flex w-full grow-0 basis-full flex-col gap-1 items-start">
                  ...
                  <Input
                    value={url}
                    onChange={(e) => {
                      setProp((props) => (props.url = e.target.value), 0)
                    }}
                    type={"text"}
