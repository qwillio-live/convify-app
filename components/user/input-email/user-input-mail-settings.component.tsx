...
export const UserInputMailSettings = () => {
  ...
  const {outlinedPresetMail, underlinedPresetMail} = useInputMailThemePresets();
        ...
        <AccordionItem value="styles">
          ...
          <AccordionContent className="grid grid-cols-2 gap-y-2 p-2">
            ...
            >
              ...
              <UserInputMailGen {...outlinedPresetMail} floatingLabel={true} size="full" enableIcon={true} marginLeft="0" marginRight="0" backgroundColor="#fff" label={t("Label")}  />
              </Card>
              <Card onClick={() => {
              ...
              >
                <div className="absolute w-full h-full bg-white-50/0 z-10"></div>
                <UserInputMailGen {...underlinedPresetMail} floatingLabel={true} size="full" enableIcon={true} marginLeft="0" marginRight="0" backgroundColor="#fff" label={t("Label")} />
              </Card>
            </div>
          </AccordionContent>
        </AccordionItem>
