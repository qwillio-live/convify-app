      ...
      <AccordionItem value="item-1" className="border-b-0">
        ...
        <AccordionContent className="w-full">
          ...
          <div className="  hidden md:block">
            ...
            >
              <div className="text-xs text-muted-foreground scale-[.30]  w-[40vw] h-auto top-0 bottom-[70%]">
    ...
    <>
      {!editing && (
        <div className="flex items-center " onClick={() => setEditing(true)}>
          <div className="flex flex-row gap-1 items-center border border-transparent text-current bg-slate-gray-200 grow justify-end hover:cursor-text">
