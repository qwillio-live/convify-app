...
export const LoaderSettings = () => {
    ...
    const uploadToS3 = async (imageData, aspectRatio, actualWidth, actualHeight) => {
        ...
        const desktopDimensions = calculateImageDimensions(aspectRatio, maxWidthDesktop)

        const formData = new FormData();
        formData.append('image', imageData);
        formData.append('file', imageData);
        formData.append('sizes[0]', `${mobileDimensions.width}x${mobileDimensions.height}`);
        formData.append('sizes[1]', `${desktopDimensions.width}x${desktopDimensions.height}`);
            ...
            <Accordion
                ...
                <AccordionItem value="item-2">
                    ...
                    <AccordionContent className="grid grid-cols-2 gap-y-2 p-2">
                        ...
                        <div className="style-control mt-2 col-span-2 flex w-full grow-0 basis-full flex-col gap-2 items-start">
