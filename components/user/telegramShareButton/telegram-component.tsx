...
import { TelegramShareButtonSettings } from "./telegram-button.settings"
...
export const TelegramShareButtonGen = ({
  disabled,
  fontFamily,
  enableIcon,
  size,
    ...
    >
      <Link
        href={`https://telegram.me/share/url?url=${encodeURIComponent(
          url
        )}&text=${encodeURIComponent(chatMessage)}`}
        className="contents"
        target="_blank"
      >
        <StyledCustomButton
...
export const TelegramShareButton = ({
  fontFamily,
  disabled,
  borderHoverColor,
  enableIcon,
  ...
  return (
    ...
    >
      {hover && <Controller nameOfComponent={t("Telegram Button")} />}
...
TelegramShareButton.craft = {
  props: IconButtonDefaultProps,
  related: {
    settings: TelegramShareButtonSettings,
  },
}
