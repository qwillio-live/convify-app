...
import { IconButtonProps, IconButtonSizes } from "./telegram-component"
...
const useTelegramButtonTheme = () => {
  ...
  const TelegramFilledPreset: IconButtonProps = {
    fontFamily: {
    ...
    background: {
      value: getBackgroundForPreset(
        "#0088cc", // Lighter gray color for filled preset
        "filled"
      ),
      globalStyled: true,
      isCustomized: false,
    ...
    backgroundHover: {
      value: getHoverBackgroundForPreset(
        "#00a6f5", // Lighter gray color for filled preset hover
        "filled"
      ),
      globalStyled: true,
      isCustomized: false,
    ...
    borderColor: {
      value: "#0088cc", // Lighter gray color for filled preset border
      globalStyled: true,
      isCustomized: false,
    },
    borderHoverColor: {
      value: darken(0.05, "#00a6f5"), // Slightly darker gray for hover state
      globalStyled: true,
      isCustomized: false,
    },
...
export default useTelegramButtonTheme
