...
export const UserInputPhoneSettings = () => {
  ...
  const {outlinedPresetPhone, underlinedPresetPhone} = useInputPhoneThemePresets();
        ...
        <AccordionItem value="styles">
          ...
          <AccordionContent className="grid grid-cols-2 gap-y-2 p-2">
            ...
            >
              ...
              <UserInputPhoneGen {...outlinedPresetPhone} floatingLabel={true} size="full" enableIcon={true} marginLeft="0" marginRight="0" backgroundColor="#fff" label={t("Label")}  />
              </Card>
              <Card onClick={() => {
              ...
              >
                <div className="absolute w-full h-full bg-white-50/0 z-10"></div>
                <UserInputPhoneGen {...underlinedPresetPhone} floatingLabel={true} size="full" enableIcon={true} marginLeft="0" marginRight="0" backgroundColor="#fff" label={t("Label")} />
              </Card>
            </div>
          </AccordionContent>
        </AccordionItem>
