...
import { getBackgroundForPreset, getHoverBackgroundForPreset } from "./useTextImageThemePresets"
    ...
    return (
        <div className="flex w-full flex-col items-center justify-between ">
            <Image
                ...
                className="size-full"
            />
            <div className="mt-6 text-start items-start self-start">
                <p className="text-[37px] font-bold" style={{
                    maxWidth: '100%',
                ...
                <p className="text-[17px] font-normal mt-3" style={{
                    maxWidth: '100%',
    ...
    useEffect(() => {
        const handleResize = () => {
            if (mobileScreen && size == 'small') {
                setProp((props) => (props.width = '85%', props.size = 'small'), 1000);
            } else if (mobileScreen && size == 'medium') {
                setProp((props) => (props.width = '85%', props.size = 'medium'), 1000);
            } else if (mobileScreen && size == 'large') {
                setProp((props) => (props.width = '85%', props.size = 'large'), 1000);
            } else if (mobileScreen && size == 'full') {
                setProp((props) => (props.width = '90%', props.size = 'full'), 1000);
            } else if (!mobileScreen && size == 'small') {
                setProp((props) => (props.width = '80%', props.size = 'small'), 1000);
            } else if (!mobileScreen && size == 'medium') {
                setProp((props) => (props.width = '90%', props.size = 'medium'), 1000);
            } else if (!mobileScreen && size == 'large') {
                setProp((props) => (props.width = '95%', props.size = 'large'), 1000);
            } else if (!mobileScreen && size == 'full') {
                setProp((props) => (props.width = '100%', props.size = 'full'), 1000);
            }
        }
            ...
            <div className="relative w-full"
                ...
                >
                    {isHovered && <Controller nameOfComponent={t("Text & Image")} />}
                    {
                        /* eslint-disable-next-line @next/next/no-img-element */
                        <UserLogo
                            fontFamily={fontFamily} color={color} setProp={setProp} size={size} Text={text} title={title} disabled={disabled} alt={alt}
