            ...
            <Accordion
                ...
                <AccordionItem value="item-2">
                    ...
                    <AccordionContent className="grid grid-cols-2 gap-y-2 p-2">
                        <div className="style-control col-span-2 flex flex-col">
                            <p className="text-sm text-muted-foreground">{t("Image Position")}</p>
                            <Tabs
                                value={position}
                    ...
                    <AccordionContent className="grid grid-cols-2 gap-y-2 p-2">
                        <div className="style-control col-span-2 flex w-full grow-0 basis-full flex-col gap-2">
                            ...
                            <Slider
                                ...
                                step={1}
                                onValueChange={(e) =>
                                    handlePropChangeDebounced("split", e)
                                }
                            />
                        </div>
                    </AccordionContent>
                ...
                <AccordionItem value="design">
                    ...
                    <AccordionContent className="grid grid-cols-2 gap-y-4 p-2">
                        ...
                        <div className="style-control col-span-2 flex flex-col">
                            <p className="text-md flex-1 text-muted-foreground">{t("Title Font Weight")}</p>
                            <Select
                        ...
                        <div className="style-control col-span-2 flex flex-col">
                            <p className="text-md flex-1 text-muted-foreground">{t("Text Font Weight")}</p>
                            <Select
