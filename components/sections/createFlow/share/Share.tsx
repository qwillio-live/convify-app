...
import { Mail, Minus, PenLine, Plus, QrCode } from "lucide-react"
            ...
            <div className="h-full px-10 py-8">
              ...
              <div className="flex  h-full flex-col">
                ...
                <div className="flex min-w-0 !flex-[1_0_auto] flex-col items-center">
                  <div
                    className="w-full flex-[1_0_auto] rounded-[20px] overflow-hidden border border-[#E9E9E9] transition-[width] duration-300 ease-in will-change-[width]"
                    style={{
        ...
        >
          <div className="p-4">
            ...
            <div className="mt-4">
              ...
              <div className="rounded-[8px] bg-[rgb(240,240,240)] p-4 text-[rgb(38,38,38)]">
                <p
                  className="mb-2 text-sm font-semibold"
                  style={{ fontSize: "14px", color: "#262627" }}
                >
                ...
                <Button
                  className="w-full bg-[rgb(211,211,211)] text-sm text-[rgb(38,38,38)] hover:bg-[rgb(218,218,218)]"
                  onClick={() => {
                    setDesktopDrawerOpen(true)
                    setShareDrawerOpen(false)
                  }}
